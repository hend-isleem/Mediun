        ...
        <div className='container'>
          ...
          <div className='articleSoical'>
            <div className='claps'>
              ...
              <span id='clapsNumber'>
                {this.props.article.clapsNumber} claps
              </span>
            </div>
            <div className='social'>
              <ul className='socialMedia'>
                ...
                <li className='socialItem'>
                  <a href='#'>
                    <i id='twitter' className='fa fa-twitter fa-2x'></i>
                  </a>
                </li>
                <li className='socialItem'>
                  <a href='#'>
                    <i id='bookmark' className='fa fa-bookmark fa-2x'></i>
                  </a>
                </li>
                <li className='socialItem'>
                  <a href='#'>
                    <i id='dots' className='fa fa-ellipsis-h fa-2x'></i>
                  </a>
                </li>
              </ul>
            </div>
